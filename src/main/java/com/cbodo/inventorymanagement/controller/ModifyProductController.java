...
/**
 * ModifyProductController controls logic of Modify Product form.
 *
 * FUTURE ENHANCEMENT:
 ...
 * @author Craig Bodo
 */
public class ModifyProductController extends MainController {
    /**
    ...
    /**
     * Index of duplicate product if applicable
     */
    private int index;
    /**
    ...
    /**
     * Populates text fields with existing product data passed from MainController.
    ...
    /**
     * Initializes all parts and associated parts tables.
     */
    @Override
